...
public class AdminController {
    ...
    public ResponseEntity<ApiResponse<List<UserRole>>> getRoleRequests(
    ...
    public ResponseEntity<ApiResponse<String>> approveRole(
    ...
    public ResponseEntity<ApiResponse<String>> suspendRole(
            @Parameter(description = "사용자 ID") @RequestParam Long userId,
            @Parameter(description = "역할명") @RequestParam String roleName) {
